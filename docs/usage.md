...
be a valid git repository with at least one remote defined. This is paramount
...
<details>
  <summary>_Workaround to create a local-only git repository_</summary>
...
no guarantees for any results without proper and correct git metadata.
