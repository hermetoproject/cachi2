...
class PackageRejected(UsageError):
    """Application refused to process the package the user requested.
...
class UnexpectedFormat(UsageError):
    """Application failed to parse a file in the user's package (e.g. requirements.txt)."""
...
class UnsupportedFeature(UsageError):
    """Application doesn't support a feature the user requested.
...
class FetchError(BaseError):
    """Application failed to fetch a dependency or other data needed to process a package."""
